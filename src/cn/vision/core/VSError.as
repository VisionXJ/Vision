package cn.vision.core
{
	 ...
	 * 
	 */
	public class VSError extends Error implements IID, IName, IDestroy
	{
		...
		{
			super($message, ErrorManager.retrieveErrorID(this));
		...
		{
			return vs::className = vs::className || ClassUtil.getClassName(this, false);
		}
